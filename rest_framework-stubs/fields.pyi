...
from rest_typed.utils.decorators import instance_type
...
@instance_type(datetime.timedelta)
...
@instance_type(Union[Dict[str, Any], List[Dict[str, Any]]])
class JSONField(
    Field[
